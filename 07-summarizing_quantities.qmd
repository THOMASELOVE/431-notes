...
- a measure of `Skewness` and its standard error. This Skewness measure refers to how much asymmetry is present in the shape of the distribution. The measure is not the same as the *nonparametric skew* measure that we will usually prefer. The [Wikipedia page on skewness](https://en.wikipedia.org/wiki/Skewness) is very detailed.
